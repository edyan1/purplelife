 ...
 */
 ...
 Game.prototype.initConstants = function() {
    ...
    winText7 = "The current Purple Nation leadership came into power forty years ago, after a very short civil war.";
    winText8 = "People celebrated back then. However, not all of its citizens are happy with the way things are now.";
    winText9 = "A rebellion rose up a few years ago. The current rulers thought they could squash it easily.";
    winText10 = "But the rebellion gained increasing support from citizens as the leading party continually tried to erase them.";
    winText11 = "One might describe the Purple Nation's ruling party as 'oppressive' or maybe despotic'.";
    winText12 = "Yet no one can deny the power they possess. As a matter of fact, thats how they overthrew the previous regime.";
    winText13 = "An alliance of corporations and military, tired of the corruption of the previous government, swiftly removed the old leaders.";
    winText14 = "However as they say, power corrupts and absolute power corrupts absolutely.";
    winText15 = "With the nation under martial law, the corporate and military oligarchy realized they could do whatever they want.";
    winText16 = "And soon enough they had complete control. Approval ratings went down, not that they mattered.";
    winText17 = "The nation was no doubtedly becoming stronger, and richer, while personal freedoms were being eroded.";
    winText18 = "Until one day people had had enough. A band of freedom fighters with support from a faction of military mutineers formed.";
    winText19 = "The Purple Liberation Miltia, at first scattered and unorganized, now have a legtimate chance of overthrowing the government.";
    winText20 = "With more of the common people supporting them than the currently in-power Soviet Purple Republic, things might swing in their favor.";
    winText21 = "The PLM grow stronger everyday. They believe in their cause. They have the people on their side.";
    winText22 = "The SPR are still very formidable however. They have foreign allies and immense wealth.";
    winText23 = "And here we are at the peak of conflict, on the brink of revolution; both sides having much to lose and everything to gain.";
    winText24 = "The final days approach. The fate of the nation will be decided in these upcoming battles.";
    winText25 = "They were well protected, but not well enough. With those targets eliminated, we've come ever closer to closing this out. ";
    winText26 = "Another set of well-guarded targets taken out. We'll be heading to their bases next.";
    winText27 = "Excellent job taking out those military bases. They won't have a fighting chance.";
    winText28 = "The enemy fleet has been destroyed. We're on the verge of victory.";
    winText29 = "Prepare for our final battle. This conflict will be decided soon.";
    ...
    winText31 = "'eeeyyyy you won!";
    winText32 = "Nothing can you stop, you're all the way up!";
    winText33 = "Ok, that one was probably a bit too easy.";
    winText34 = "Wow you actually beat that level? Did you cheat? I think you cheated.";
    winText35 = "See, you didn't need all 6 weapons!";
    winText36 = "Thank you for playing!!";
